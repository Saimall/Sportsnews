...
const ArticleListItem = ({
  ...
  const [articleDetailsData, setArticleDetailsData] = useState<Article | null>(
    null,
  );
            ...
            <Dialog.Panel className="bg-white rounded-lg shadow-lg max-w-3xl w-full p-6 overflow-hidden">
              ...
              {articleDetailsData && (
                <div>
                  ...
                  <div className="w-full h-full object-cover rounded-md transition-transform transform hover:scale-105 bg-white">
